...
//    Translation2d
    ...
    public void init() {
        ...
        rer = hardwareMap.get(Servo.class, "rer");
...
//            drive = -gamepad1.right_trigger;
            strafe = -gamepad1.left_stick_x  + strafedelta;
...
//        telemetry.addData("Heading", "%.3f", imu.getRobotYawPitchRollAngles().getYaw(AngleUnit.DEGREES));
