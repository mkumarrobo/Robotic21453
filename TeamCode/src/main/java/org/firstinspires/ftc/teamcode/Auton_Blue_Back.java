...
@Autonomous(name = "AUTON BLUE BACK", group = "Iterative Opmode")
...
//        St_Enc(2.5);
        ...
        while ((runtime.seconds() <= 2)) {
            if ((Dist_OR.getDistance(DistanceUnit.CM) < 55)) {
                Pixel_Pos = 1;
            }
        ...
        if (Pixel_Pos == 3) {
            No_St_Drive_Enc(2.5, default_drive_power);
            Set_Heading = 50;
            runtime.reset();
...
//            }
            ...
            St_Enc(-3.5);
            No_St_Drive_Enc(42, default_drive_power);
            Twist_IMU(90);
