...
@Autonomous(name = "AUTON RED BACK", group = "Iterative Opmode")
...
//    Camera parameters
    ...
    private static final String TFOD_MODEL_ASSET = "Red_Crown_Field.tflite";
...
//            St_Enc(-5);
            ...
            Twist_IMU(0);
            No_St_Drive_Enc(39, default_drive_power);
            Twist_IMU(-90);
            No_St_Drive_Enc(93, 1);
            imu.resetYaw();
            sleep(500);
            St_Enc(-10);
            ELBOW_Go(800);
